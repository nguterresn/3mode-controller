...
#define CALIBRATION_DELTA (256) // The lower the Vref, the bigger should be this number.
...
static uint16_t joystick_mitigate_noise(uint16_t read)
{
	if ((CALIBRATION_ZER0 < read && read < (CALIBRATION_ZER0 + CALIBRATION_DELTA)) ||
	    (CALIBRATION_ZER0 > read && read > (CALIBRATION_ZER0 - CALIBRATION_DELTA))) {
